  ...
  return (
    <div className="grid min-h-screen place-items-center bg-slate-100 p-6 dark:bg-slate-950">
      <form className="w-full max-w-md rounded-2xl bg-white p-6 shadow-sm dark:bg-slate-900" onSubmit={handleSubmit(onSubmit)}>
        <Text size="2xl" className="font-bold text-slate-950 dark:text-white">Forgot password</Text>
        <Text size="sm" className="mt-1 text-slate-500 dark:text-slate-400">Enter your email and we&apos;ll send you a reset link.</Text>
