  ...
  return (
    <div className="grid min-h-screen place-items-center bg-slate-100 p-6 dark:bg-slate-950">
      <div className="max-w-md rounded-2xl bg-white p-8 text-center shadow-sm dark:bg-slate-900">
        <Text size="3xl" className="font-bold text-slate-950 dark:text-white">Page not found</Text>
        <Text className="mt-2 text-slate-500 dark:text-slate-400">This route is not part of the Wealth System yet.</Text>
